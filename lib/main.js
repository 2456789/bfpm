var AsyncTasks, BOOTSTRAP_LESS_FILES, BRICKS_FRAMEWORK_URL, bricksPM, EventEmitter, UglifyJS, async, fs, less, minimatch, path, targz, utils, _,
...
BRICKS_FRAMEWORK_URL = "https://github.com/BricksFramework/Bricks/archive/<%=version%>.tar.gz";
...
bricksPM = (function(_super) {
  __extends(bricksPM, _super);

  function BricksPM(dir, options) {
    if (options == null) {
      options = {};
    }
  ...
  bricksPM.prototype.init = function() {
    ...
    this.on("download", function(next) {
      ...
      url = _.template(BRICKS_FRAMEWORK_URL, {
  ...
  bricksPM.prototype.run = function(cb) {
    var events;
